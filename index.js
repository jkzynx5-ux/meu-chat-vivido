...
// Limite de 20mb para suportar áudios e fotos na conversa
...
io.on('connection', (socket) => {
    socket.on('join-room', (dados) => {
        ...
        socket.avatar = dados.user.avatar;
    ...
    socket.on('typing', (status) => {
        socket.to(socket.currentRoom).emit('user-typing', { username: socket.username, typing: status });
    });
...
http.listen(PORT, () => console.log('Servidor rodando com suporte a Multimídia!'));